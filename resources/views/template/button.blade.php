          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <nav class="az-menu-sub">
                <a href="eightpage" class="nav-link">Sign In</a>
        ...
        <div class="az-content-left az-content-left-components">
          <div class="component-item">
            ...
            <nav class="nav flex-column">
              <a href="thirdpage" class="nav-link active">Buttons</a>
              <a href="thirdpage" class="nav-link">Dropdown</a>
              <a href="sevenpage" class="nav-link">Icons</a>
            </nav>

            <label>Forms</label>
            <nav class="nav flex-column">
              <a href="tenpage" class="nav-link">Form Elements</a>
            </nav>
            ...
            <label>Tables</label>
            <nav class="nav flex-column">
              <a href="tesla" class="nav-link">Basic Tables</a>
            </nav>
          </div><!-- component-item -->
