    ...
    <div class="az-signup-wrapper">
      <div class="az-column-signup-left">
        <div>
          ...
          <a href="firstpage" class="btn btn-outline-indigo">Learn More</a>
        </div>
      ...
      <div class="az-column-signup">
        ...
        <div class="az-signup-header">
          ...
          <form action="page-profile.html">
            ...
            <button class="btn btn-az-primary btn-block"><a href="firstpage">Create Account</a></button>
        ...
        <div class="az-signup-footer">
          <p>Already have an account? <a href="firstpage">Sign In</a></p>
